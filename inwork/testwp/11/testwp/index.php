...
<div class="header">
    <div class="wrapper">
        <div class="top clearfix">
            ...
            <div class="tel">
                <p class="but-left"><span><img src="<?php bloginfo("template_directory"); ?>/img/whatsapp.png" alt=""></span><span><img src="<?php echo get_template_directory_uri(); ?>/img/tel.png" alt=""></span>8 923 460 8362</p>
...
<div id="modal_form2">
    <div class="form" style="padding-top:20px;height: 290px;">
        <form action="javascript:void(null);" id="modal3">
            <h1 style="margin-top:5px;margin-bottom:7px;">Остаьвте заявку</h1>
