...
<body>
	<div class="container">
		...
		<div class="nav_side">
			<p style="color:#202020;"><b>Sales</b><i class="ion-android-sync"></i></p>
			<span><button><a href="#" target="#">Dashboard</a></button></span>
			<ul>
				<li  class="main_head"><img src="../../img/new_arrow.png">SALES</li>
				<ul id="misc" >
					<li onclick="changeframe('dsp_saleslist.cfm');">Sales</li>
					<li>Purchase Gift Cert</li>
					<li>Passcode Maintenance</li>
					<li>Issue Voucher (Non-Transfer)</li>
					<li>Credit Note</li>
				</ul>
			</ul>
			...
			<ul>
				...
				<ul id="secndle">
					<li onclick="changeframe('../master/product/dsp_mainpage.cfm');">Product Setup</li>
					<li onclick="changeframe('../master/service/dsp_mainpage.cfm');">Service Setup</li>
					<li onclick="changeframe('../master/packages/dsp_mainpage.cfm');">Package Setup</li>
				</ul>
			</ul>
