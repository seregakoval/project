...
<head>
    ...
    <style>
        ...
        #item_collection_content{overflow-y:scroll;
...
<div id="center_window">
              ...
              <div id="item_collection_content">
                   <table class="table_head head-tbl">
                       <tr>
                   ...
                   <iframe src="dsp_collection.cfm?custid=#custid#"
                           id="page03_item_table" class="fra"
                           frameBorder="1"
                           scrolling="no"></iframe>
               </div>
...
<table id="table_body" class="boy">
	...
	<div>
		<div id="submit_collection" class="orange_button fff">Submit Collection</div>
    </div>
    <script>
    ...
    <script>
        ...
        document.getElementById("contentHolder").classList.add('hidden');
        function switch_tab(elem){
            ...
            switch (elem.id) {
                ...
                case "history_tab":
                    ...
                    document.getElementById("contentHolder").classList.remove('hidden');
