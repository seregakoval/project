...
<SCRIPT>
	...
	function update(docid,doccode,docname,rate) {
		top.window.opener.document.itemform.purtaccode.value = doccode;
		top.window.opener.document.itemform.purtaxname.value = docname;
		top.window.opener.document.itemform.defaultpurchasetax.value = docid;
		top.window.opener.dataupdate(docid,'defaultpurchasetax');
