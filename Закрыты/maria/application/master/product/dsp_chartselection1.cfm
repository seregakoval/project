...
function searchrecords(){
	...
	itemframe.location = "dsp_chartselectionlist1.cfm?searchchartcode=" + searchchartcode + "&searchchartdesc=" + searchchartdesc + "&displaylevel=2" + "&searchtype=" + searchtype;
}
</script>
...
<table class="basetable">
	...
	<tr>
		<td colspan="100%" style="height:520px;">
			<iframe id="itemframe" name="itemframe"  src="dsp_chartselectionlist1.cfm" style="height:100%;width:100%;border:0px solid ##647796;overflow:auto;"></iframe>
		</td>
	</tr>
</table>
</form>
