...
function searchrecords(){
	...
	searchframe.location = "dsp_selectgstlist2.cfm?searchcode=" + searchcode + "&searchtdesc=" + searchtdesc ;
}
</script>
...
<table class="basetable">
	...
	<tr>
		<td colspan="100%" style="height:530px;">
			<iframe id="searchframe" name="searchframe"  src="dsp_selectgstlist2.cfm" style="height:100%;width:100%;border:0px solid ##647796;overflow:auto;"></iframe>
		</td>
	</tr>
</table>
</form>
