...
function update(accname,acccode,accid){
	top.window.opener.document.itemform.assettaxname1.value = accname;
	top.window.opener.document.itemform.assettaxcode1.value = acccode;
	top.window.opener.document.itemform.assetchargeid1.value = accid;
	top.window.opener.dataupdate(accid,'assetchargeid1');
	top.window.close();
