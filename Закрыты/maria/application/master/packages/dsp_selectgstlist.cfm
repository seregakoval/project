...
<SCRIPT>
	...
	function update(docid,doccode,docname,rate) {
		top.window.opener.document.itemform.suptaxcode.value = doccode;
		top.window.opener.document.itemform.suptaxname.value = docname;
		top.window.opener.document.itemform.defaultsuppllytax.value = docid;
		top.window.opener.dataupdate(docid,'defaultsuppllytax');
