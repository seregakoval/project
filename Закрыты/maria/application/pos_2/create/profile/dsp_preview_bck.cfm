...
<table class="previewmaintable">
	<tr>
		<td class="maintitle2">RECURRING JOURNAL</td>
	</tr>
</table>
<table class="previewmaintable">
	<tr>
		<td style="text-align:center;padding-top:8px;padding-bottom:8px;vertical-align:top;">
			<table class="previewtable" style="width:90%;">
				<tr>
					<td class="previewnamecell" style="width:150px;">Trx No. </td>
					<td style="width:5px;" class="previewnamecell">:</td>
					<td class="previewvaluecell">GLCD-#getdet.trans_no#</td>
			...
			<table class="datatable" style="width:100%;">
				...
				<tr>
					<td class="datasum" colspan="4" style="text-align:right;" >Total</td>
