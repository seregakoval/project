...
function update(projectname,partname,projectid,partid) {
	top.window.opener.document.itemform.projectname.value = projectname;
	top.window.opener.document.itemform.partname.value = partname;
	top.window.opener.document.itemform.projectid.value = projectid;
	top.window.opener.document.itemform.part_no.value = partid;
	top.window.close();
}
</cfoutput>
	...
	<cfloop query="getproject">				
		<tr>						
			<td class="datatabledatacell_#(getproject.currentRow%2)#" style="text-align:left;">
				&nbsp;&nbsp;<img align="absmiddle" src="../../images/lib.gif" width=16 height=16>&nbsp;&nbsp;<a class="nevelink" href="dsp_selectprojectlist2.cfm?id=#getproject.projectid#&displaylevel=2">#htmleditformat(getproject.projectcode)# - #htmleditformat(getproject.sdesp)#</a>
			</td>
		</tr>		
	</cfloop>
	</table>
		...
		<table class="searchtable">
			<tr>						
				<td class="searchheaderrow" style="padding-left:10px;">
					&nbsp;&nbsp;<img align="absmiddle" src="../../images/lib.gif" width=16 height=16>&nbsp;&nbsp;<a class="nevelink" href="dsp_selectprojectlist2.cfm?id=&displaylevel=1">#htmleditformat(getproject.projectcode)# - #htmleditformat(getproject.sdesp)#</a>
				</td>
			</tr>
		</table>
	<cfelse>	
		<table class="searchtable">
			<tr>						
				<td class="datatabledatacell_#(rcount%2)#" style="text-align:left;padding-left:10px;">
					&nbsp;&nbsp;<img align="absmiddle" src="../../images/lib.gif" width=16 height=16>&nbsp;&nbsp;<a class="nevelink" href="dsp_selectprojectlist2.cfm?id=&displaylevel=1">&nbsp;</a>
				</td>
			</tr>
		</table>	
	</cfif>
...
<cfelseif displaylevel eq "3">
	...
	<cfquery name="getpart" datasource="#dbname#">
		select project.projectid,part.part_no,project.sdesp,part.part_desp ,project.projectcode,part.part_code
		from part,project
		where project.projectid= part.projectid
                and project.projectid !='0'
				and project.stage = '1'
		<cfif searchprojectcode NEQ "" and searchprojectcode NEQ "Code">
			<cfif  isdefined("searchtype") and searchtype EQ "start">
				 and (trim(upper(project.projectcode)) like '#trim(ucase(searchprojectcode))#%'
				 	or trim(upper(part.part_code)) like '#trim(ucase(searchprojectcode))#%'
				 )
			<cfelse>
				 and (trim(upper(project.projectcode)) like '%#trim(ucase(searchprojectcode))#%'
				 	or  trim(upper(part.part_code)) like '%#trim(ucase(searchprojectcode))#%'
		...
		<cfelseif searchprojectdesc NEQ "" and searchprojectdesc NEQ "Description">
			<cfloop list="#searchprojectdesc#" delimiters=" " index="thisdesc">
				<cfif isdefined("searchtype") and searchtype EQ "start">
					and (trim(upper(project.sdesp)) like '#trim(ucase(thisdesc))#%'
						or trim(upper(part.part_desp)) like '#trim(ucase(thisdesc))#%'
					)
				<cfelse>
				 	and (trim(upper(project.sdesp)) like '%#trim(ucase(thisdesc))#%'
				 		or trim(upper(part.part_desp)) like '%#trim(ucase(thisdesc))#%'
				...
				<table class="searchtable">
					<tr>						
						<td  class="searchheaderrow" style="padding-left:0px;">
							&nbsp;&nbsp;<img align="absmiddle" src="../../images/lib.gif" width=16 height=16>&nbsp;&nbsp;<a class="nevelink" href="dsp_selectprojectlist2.cfm?id=&displaylevel=1">#htmleditformat(getpart.projectcode)# - #htmleditformat(getpart.sdesp)#</a>
						</td>
					</tr>
				</table>
