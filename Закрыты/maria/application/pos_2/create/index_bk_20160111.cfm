...
<body>
    ...
    <div class="right_win">
        ...
        <div id="nav_bar">
            ...
            <div class="outer_wrap" title="Activity" onclick="changeframe('page11_iframe_main.html');">
                <i class="icon ion-android-settings"></i>
            </div>
            <div class="outer_wrap" title="Profile" id="current"  onclick="changeframe('page01_iframe_main.html');">
				profile/dsp_profile.cfm
           ...
           <!---  </a> --->
           <!---  <a href="page09.html"> --->
                <div class="outer_wrap" title="Point" onclick="changeframe('page09_iframe_first_table.html');">
                    <i class="icon ion-heart"></i>
                </div>
           <!---  </a> --->
           <!---  <a href="page08.html"> --->
                <div class="outer_wrap" title="Service" onclick="changeframe('page08_iframe_main.html');">
                    <i class="icon ion-happy-outline"></i>
                </div>
            <!--- </a> --->
           <!---  <a href="page10.html"> --->
                <div class="outer_wrap" title="Service History" onclick="changeframe('page10_iframe_main.html');">
