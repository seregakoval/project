...
function searchrecords(){
	...
	projectframe.location = "dsp_selectprojectlist1.cfm?iid=0&displaylevel=3&searchprojectcode=" + searchprojectcode + "&searchprojectdesc=" + searchprojectdesc + "&pro=";
}
</script>
...
<table class="basetable">
	...
	<tr>
		<td colspan="100%" style="height:530px;">
			<iframe id="projectframe" name="projectframe"  src="dsp_selectprojectlist1.cfm?iid=0&displaylevel=1" style="height:100%;width:100%;border:0px solid ##647796;overflow:auto;"></iframe>
		</td>
	</tr>
</table>
</form>
