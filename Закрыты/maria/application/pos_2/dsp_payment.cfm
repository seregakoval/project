            ...
            <div id="balance_content">
                <table class="table_head">
                    <tr>
                        ...
                        <td width="16%" rowspan="2">Make Payment</td>
                    </tr>
                    <tr>
                        <td width="10.5%">Inv ##</td>
                        <td width="14.5%">Doc Amt</td>
                        <td width="14.5%">Paid Amt</td>
                        <td width="15%">Amt Payable</td>
                        <td width="13.5%">Entry By</td>
                        <td width="15.8%">Date</td>
                    </tr>
                </table>
			</div>
