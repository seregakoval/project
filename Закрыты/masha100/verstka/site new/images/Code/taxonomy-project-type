...
<div class="container-wrap">
	...
	<div class="container" data-col-num="cols-<?php echo $cols; ?>">
		...
		<div id="portfolio" class="row portfolio-items <?php if($masonry_layout == 'true') echo 'masonry-items'; ?>"  data-categories-to-show="" data-starting-filter="" data-col-num="<?php echo $cols; ?>">
			<?php 
